/*!
librasa7890 的 Substore 订阅转换脚本
https://github.com/librasa7890/override-rules
  ...
  function buildProxyGroups({
    ...
    const groups = [
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/librasa7890/override-rules@master/icons/Microsoft_Copilot.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/librasa7890/override-rules@master/icons/Truth_Social.png`,
        type: "select",
        proxies: hasUS ? ["美国节点", PROXY_GROUPS.SELECT, PROXY_GROUPS.MANUAL] : defaultProxies
      },
      {
        name: PROXY_GROUPS.EHENTAI,
        icon: `${CDN_URL}/gh/librasa7890/override-rules@master/icons/Ehentai.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
        name: PROXY_GROUPS.PIKPAK,
        icon: `${CDN_URL}/gh/librasa7890/override-rules@master/icons/PikPak.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
        name: PROXY_GROUPS.SOGOU_INPUT,
        icon: `${CDN_URL}/gh/librasa7890/override-rules@master/icons/Sougou.png`,
        type: "select",
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `DOMAIN-SUFFIX,oaistatic.com,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,oaiusercontent.com,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,anthropic.com,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,claude.ai,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,notebooklm.google,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,notebooklm.google.com,${PROXY_GROUPS.AI_SERVICE}`,
        `DOMAIN-SUFFIX,notebooklm.googleapis.com,${PROXY_GROUPS.AI_SERVICE}`,
    ...
    "src/rule_providers.ts"() {
      ...
      ruleProviders = {
        ...
        TikTok: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/TikTok.list`,
        ...
        EHentai: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/EHentai.list`,
        ...
        SteamFix: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/SteamFix.list`,
        ...
        GoogleFCM: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/FirebaseCloudMessaging.list`,
        ...
        AdditionalFilter: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/AdditionalFilter.list`,
        ...
        AdditionalCDNResources: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/AdditionalCDNResources.list`,
        ...
        Crypto: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/Crypto.list`,
        ...
        Weibo: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/librasa7890/override-rules@master/ruleset/Weibo.list`,
    ...
    "src/main.ts"() {
      ...
      function getRawArgs() {
        try {
          ...
          console.log("[librasa7890 的覆写脚本] 未检测到传入参数，使用默认参数。", {});
          return {};
        }
      }
